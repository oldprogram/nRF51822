...
/* Bit 7 : Shortcut between DISABLED event and BCSTOP task. */
#define RADIO_SHORTS_DISABLED_BCSTOP_Pos (7UL) /*!< Position of DISABLED_BCSTOP field. */
#define RADIO_SHORTS_DISABLED_BCSTOP_Msk (0x1UL << RADIO_SHORTS_DISABLED_BCSTOP_Pos) /*!< Bit mask of DISABLED_BCSTOP field. */
#define RADIO_SHORTS_DISABLED_BCSTOP_Disabled (0UL) /*!< Shortcut disabled. */
#define RADIO_SHORTS_DISABLED_BCSTOP_Enabled (1UL) /*!< Shortcut enabled. */
...
/* Bit 8 : Enable interrupt on BCMATCH event. */
#define RADIO_INTENSET_BCMATCH_Pos (8UL) /*!< Position of BCMATCH field. */
...
/* Bit 8 : Disable interrupt on BCMATCH event. */
#define RADIO_INTENCLR_BCMATCH_Pos (8UL) /*!< Position of BCMATCH field. */
...
#define RADIO_TXPOWER_TXPOWER_Neg40dBm (0xD8UL) /*!< -40dBm. */
...
/* Bit 1 : TX buffer overread detected, and prevented. */
#define SPIS_STATUS_OVERREAD_Pos (1UL) /*!< Position of OVERREAD field. */
...
#define SPIS_STATUS_OVERFLOW_Pos (0UL) /*!< Position of OVERFLOW field. */
