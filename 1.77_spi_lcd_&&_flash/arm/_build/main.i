...
#line 1 "C:\\Keil-ARM\\ARM\\RV31\\INC\\stdbool.h"
...
#line 24 "C:\\Keil-ARM\\ARM\\RV31\\INC\\stdbool.h"

#line 26 "main.c"
#line 1 "C:\\Keil-ARM\\ARM\\RV31\\INC\\stdint.h"
...
#line 25 "C:\\Keil-ARM\\ARM\\RV31\\INC\\stdint.h"
...
#line 196 "C:\\Keil-ARM\\ARM\\RV31\\INC\\stdint.h"
...
#line 260 "C:\\Keil-ARM\\ARM\\RV31\\INC\\stdint.h"
...
#line 1 "C:\\Keil-ARM\\ARM\\RV31\\INC\\core_cm0.h"
...
#line 56 "C:\\Keil-ARM\\ARM\\RV31\\INC\\core_cm0.h"
...
#line 82 "C:\\Keil-ARM\\ARM\\RV31\\INC\\core_cm0.h"
...
#line 377 "C:\\Keil-ARM\\ARM\\RV31\\INC\\core_cm0.h"
...
#line 395 "C:\\Keil-ARM\\ARM\\RV31\\INC\\core_cm0.h"
...
#line 500 "C:\\Keil-ARM\\ARM\\RV31\\INC\\core_cm0.h"
...
#line 770 "C:\\Keil-ARM\\ARM\\RV31\\INC\\core_cm0.h"
...
struct DIS{
	unsigned int cen_x,cen_y;
	unsigned int len;
	unsigned int dir;
	unsigned int pre_dir;
	_Bool dir_change;
}myDis;
void drawDIS(_Bool isPre){
	if(myDis.dir_change==1){
	
		switch(isPre==0 ? myDis.dir:myDis.pre_dir){
		case 0:	
			DrawLine(myDis.cen_x,myDis.cen_x,myDis.cen_y-myDis.len,myDis.cen_y,isPre==0 ? 0x07E0 : 0x001F);
			break;
		case 1:
			DrawLine(myDis.cen_x,myDis.cen_x,myDis.cen_y,myDis.cen_y+myDis.len,isPre==0 ? 0x07E0 : 0x001F);
			break;
		case 2:
			DrawLine(myDis.cen_x-myDis.len,myDis.cen_x,myDis.cen_y,myDis.cen_y,isPre==0 ? 0x07E0 : 0x001F);
			break;
		case 3:
			DrawLine(myDis.cen_x,myDis.cen_x+myDis.len,myDis.cen_y,myDis.cen_y,isPre==0 ? 0x07E0 : 0x001F);
			break;
		default:break;
		}
		if(isPre==0)DrawLine(myDis.cen_x-2,myDis.cen_x+2,myDis.cen_y-2,myDis.cen_y+2,0x0000);
		else drawDIS(0);
	}
}
...
int main(void)
{
   	...
   	while(1<2)
	{
		...
		myDis.dir=cnt%4;
		DispInt(cnt,128/2-16*2,160,0xF800,0x001F);
		FLASH_Buf[3]=0;
		DispStr(FLASH_Buf,x,y,0x0000,0x001F); 
		drawDIS(1);
