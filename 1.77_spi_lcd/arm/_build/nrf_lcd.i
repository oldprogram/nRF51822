...
void SendDataSPI(unsigned char dat)
{
    ...
    for(i = 0; i < 8; i++)
    {
        if( (dat & 0x80) != 0 ) nrf_gpio_pin_set(14);
        else nrf_gpio_pin_clear(14);
...
void  DispOneChar(unsigned char ord, unsigned int Xstart, unsigned int Ystart, unsigned int TextColor, unsigned int BackColor)	 
{
    ...
    BlockWrite(Xstart, Xstart + (16 - 1), Ystart, Ystart + (21 - 1));
...
void DispInt(unsigned int i, unsigned int Xstart, unsigned int Ystart, unsigned int TextColor, unsigned int BackColor)
{
    ...
    DispOneChar((i >> 12) % 16, Xstart, Ystart, TextColor, BackColor); 
    DispOneChar((i >> 8) % 16, Xstart + 16, Ystart, TextColor, BackColor);
    DispOneChar((i >> 4) % 16, Xstart + 16 * 2, Ystart, TextColor, BackColor);
    DispOneChar(i % 16, Xstart + 16 * 3, Ystart, TextColor, BackColor);
