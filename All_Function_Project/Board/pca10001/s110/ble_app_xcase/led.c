...
#define ADVERTISING_LED_PIN_NO               IND_LED                                     /**< Is on when device is advertising. */
...
#define IND_LED_ON                 nrf_gpio_pin_clear(ADVERTISING_LED_PIN_NO) //low make light on
#define	IND_LED_OFF                nrf_gpio_pin_set(ADVERTISING_LED_PIN_NO)//high make light off
...
static void gpiote_init(void)
{
    ...
    nrf_gpiote_task_config(GPIOTE_CHAN_FOR_LED_TASK,
                           ...
                           NRF_GPIOTE_INITIAL_VALUE_HIGH);//NRF_GPIOTE_INITIAL_VALUE_LOW-->HIGH
}
...
void led_stop(void)
{
    ...
    NRF_TIMER1->TASKS_STOP = 1;
	  ...
	  //IND_LED_OFF;//
	  IND_LED_ON;//high make light off
}
